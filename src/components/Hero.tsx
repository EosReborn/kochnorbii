  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col justify-center">
        ...
        <div
          className="hero-in container-edge mt-10 flex flex-col items-start gap-6 sm:mt-14 sm:flex-row sm:items-end sm:justify-between"
          style={{ animationDelay: "320ms" }}
        >
          <p className="max-w-xs font-body text-sm leading-relaxed text-stone sm:max-w-sm">
            Digital Designer &amp; Developer — digitális élményeket,
            weboldalakat és termékeket tervezek és építek.
          </p>

          <a
            href="#work"
            className="underline-hover shrink-0 font-body text-base text-paper"
          >
            Kiemelt munkák
          </a>
        </div>
